<template>
    <div class="q-pa-md">
        <q-table title="SALES" :rows="sales" :columns="columns" row-key="name" :rows-per-page-options="[10, 20, 50, 100]">
        </q-table>
...
import { LocalStorage, QTableColumn, date } from 'quasar';
...
const columns: QTableColumn[] = [
    ...
    { name: 'data', align: 'center', label: 'Date', field: 'data', sortable: true, format: (d) => date.formatDate(d, 'DD/MM/YYYY') },
